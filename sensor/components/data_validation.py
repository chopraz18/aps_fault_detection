...
class DataValidation:
    ...
    def drop_missing_values_columns(self,df:pd.DataFrame,report_key_name:str)->Optional[pd.DataFrame]:
        ...
        try:
            ...
            logging.info(f'selecting columns names containing null values above {threshold}')
    ...
    def initiate_data_validation(self):
        try:
            ...
            logging.info(f"replaced na values with np.nan in base df")
            ...
            base_df=self.drop_missing_values_columns(df=train_df,report_key_name="missing_values_within_train_dataset")
            logging.info(f"dropping null values columns from test dataframe")
            base_df=self.drop_missing_values_columns(df=test_df,report_key_name="missing_values_within_test_dataset")
            ...
            if train_df_column_status:
                logging.info(f"As all column are available in train df hence detecting data_drift")
            ...
            logging.info("Data_validation_artifact :{data_validation_artifact}")
